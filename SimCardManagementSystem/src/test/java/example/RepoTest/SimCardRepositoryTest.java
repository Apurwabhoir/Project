...
public class SimCardRepositoryTest 
{
	...
	void testsaveSimCard()
	{
		List<Customer> customerlist=Stream
				.of(new Customer(1,"Mayur",32,"Male","pune",546820,"98523012","mayur@gmail.com",200,"Active"),new Customer(2,"Adishree",22,"female","pune",326820,"9852142","Adishree@gmail.com",400,"Active"))
